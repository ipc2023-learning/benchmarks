(define (problem spanner-30)
 ...
 (:init 
    ...
    (usable spanner23)
    (at spanner24 location86)
    (usable spanner24)
    (at spanner25 location82)
    (usable spanner25)
